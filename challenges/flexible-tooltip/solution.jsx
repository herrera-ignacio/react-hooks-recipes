...
function Tip({ targetRef, children }) {
  ...
  React.useLayoutEffect(() => {
    ...
    // to determine the left position, get the center of the hovered text
    // (targetRect.left + targetRect.width / 2)
    // and then subtract half the width of the tooltip (tipRect.width / 2)
    const left = targetRect.left + targetRect.width / 2 - tipRect.width / 2;

    if (tipRect.height > spaceAbove && spaceBelow > spaceAbove) {
      setTipLayout({
        position: "bottom",
        style: { left, top: targetRect.bottom + 16 } // 16 padding
      });
    } else {
      setTipLayout({
        position: "top",
...
export default function FlexibleTooltip() {
  return (
    <main>
      <section>
        <p>
          Since its inception in the 1990s, Pokémon, originally known as "Pocket
          Monsters," has become a global cultural phenomenon. Created by Satoshi
          Tajiri and Ken Sugimori for Nintendo, the franchise began with a
          simple yet captivating idea: creatures that can be caught, trained,
          and battled. This core concept was inspired by Tajiri's childhood
          hobby of{" "}
        ...
        <p>
          The Pokémon journey officially started with the release of Pokémon Red
          and Green in Japan in 1996. These role-playing games, developed by
          Game Freak and published by Nintendo, allowed players to embark on a
          journey as a Pokémon Trainer, catching and training Pokémon to become
          the very best. The games' success in Japan prompted the creation of
          Pokémon Blue, an{" "}
          <Tooltip tip="Pokémon Blue had enhanced graphics and other improvements over the original Red and Green versions.">
            improved version
          </Tooltip>
          , which together with Red, would later be released internationally as
        ...
        <p>
          ...
          Pokémon's reach was further expanded with the introduction of trading
          card games, toys, movies, and various merchandise. The first Pokémon
          movie, "Pokémon: The First Movie - Mewtwo Strikes Back," released in
          1998, was a box office hit, paving the way for subsequent films and
          specials.
        </p>
        <p>
          ...
          ensuring that fans always had fresh content. From the introduction of
          day and night cycles in Pokémon Gold and Silver to dynamic battles in
          Pokémon X and Y, the series consistently evolved, mirroring its core
          theme of{" "}
        ...
        <p>
          ...
          explore the real world to catch Pokémon, leading to a massive cultural
          movement. Parks and city streets were filled with trainers
        ...
        <p>
          ...
          Pokémon in the newer games. However, the franchise's ability to adapt,
          reinvent, and stay relevant has seen it weather these storms
          effectively.
        </p>
        <p>
          Today, with over two decades under its belt, Pokémon stands as a
          testament to the power of imagination, innovation, and community. From
          its humble beginnings as a Game Boy title to its global recognition as
          a multimedia juggernaut, the Pokémon story is one of passion,
          creativity, and evolution. As the franchise's slogan aptly states,
          "Gotta Catch 'Em All!" – and it seems the world has eagerly heeded
          that call.
        </p>
        <p>
          While it remains to be seen where Pokémon will venture next, one thing
          is certain: its legacy as a beloved franchise that bridges generations
          and cultures is undeniable. Whether you're a first-generation fan or a
          newcomer to the Pokémon world, the allure of these charming creatures
          and the adventures they bring remains{" "}
