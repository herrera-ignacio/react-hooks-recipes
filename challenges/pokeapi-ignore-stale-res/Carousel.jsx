...
export default function Carousel({ children, onNext, onPrevious }) {
  ...
  // The problem is, unless we use useCallback, their references will be different on ever render which
  // will re-run the effect. useCallback allows us to tell React that we don't want that to happen and React
  // should treat these as always being referentially equal (the same).
