export default function Diagram () {
  return (
    ...
    >
      <title>
        Interactive diagram that toggles between a traditional approach of
        separation of concerns (HTML, CSS, and JS) and the React approach (all
        three combined in a component)
      </title>
      <defs>
        <linearGradient
          id="linear-gradient"
        ...
        >
          <stop offset={0} stopColor="#f38ba3" />
          <stop offset={0.53} stopColor="#7b5ea7" />
          <stop offset={1} stopColor="#12b5e5" />
        </linearGradient>
        <linearGradient
      ...
      <path fill="#0f0d0e" d="M-0.5 0H300V315H-0.5z" />
      <text
        transform="translate(119.28 24.96)"
        fill="#f9f4da"
      ...
      <g id="concerns">
        <text
          transform="translate(11.44 96.2)"
          fill="#f9f4da"
          fontFamily="Outfit-Regular, Outfit"
          fontSize={16}
        >
          <tspan x={0} y={0}>
            {"HTML"}
        ...
        <text
          transform="translate(27.29 176.56)"
          fill="#f9f4da"
          fontFamily="Outfit-Regular, Outfit"
          fontSize={16}
        >
        ...
        <text
          transform="translate(37.79 257.3)"
          fill="#f9f4da"
          fontFamily="Outfit-Regular, Outfit"
          fontSize={16}
        >
      ...
      <rect
        id="component1"
        className="component component1"
        x={92.49}
        y={41.76}
        width={77.42}
        height={260.47}
      ...
      <rect
        id="component2"
        className="component component2"
        x={188.65}
        y={41.76}
        width={77.42}
        height={260.47}
      ...
      />
      <rect
        id="component2Gradient"
        className="component component2Gradient"
        x={92.49}
        y={41.76}
        width={77.42}
        height={260.47}
      ...
      />
      <rect
        id="component1Gradient"
        className="component component1Gradient"
        x={188.65}
        y={41.76}
        width={77.42}
        height={260.47}
      ...
      >
        ...
        <path
          ...
          fill="#f9f4da"
        />
        <path fill="#fc7428" d="M137.78 83.32L148.69 83.8" />
      </g>
      <g
        id="cheese1"
        className="icon cheese1"
        stroke="#231f20"
        strokeLinejoin="round"
        strokeWidth={0.57}
      >
        ...
        <path
          ...
          fill="#f9f4da"
        />
        <path fill="#fcba28" d="M113.67 169.59L134.65 157.75 146.48 164.92" />
        <path
          transform="rotate(-8.1 131.19 174.937)"
          fill="#fcba28"
          d="M114.6 167.18H147.75V182.74H114.6z"
        />
      </g>
      <g
        id="pepperoni"
        className="icon pepperoni"
        stroke="#231f20"
        strokeLinejoin="round"
        strokeWidth={0.57}
      >
        ...
        <path
          ...
          fill="#bc0f31"
        />
        <circle cx={131.27} cy={250.42} r={15.6} fill="#ed203d" />
        <circle cx={135.66} cy={242.8} r={3.08} fill="#bc0f31" />
        <circle cx={125.9} cy={241.62} r={2} fill="#bc0f31" />
        <circle cx={123.9} cy={252.14} r={4.9} fill="#bc0f31" />
        <circle cx={133.23} cy={259.14} r={2.71} fill="#bc0f31" />
        <circle cx={141.68} cy={252.66} r={2.71} fill="#bc0f31" />
        <circle cx={134.74} cy={249.95} r={1.5} fill="#bc0f31" />
      </g>
      <g id="chip" className="icon chip">
        <path
      ...
      >
        ...
        <path
          ...
          fill="#f9f4da"
        />
        <path fill="#fcba28" d="M212.21 167L235.03 159.25 245.32 168.49" />
        <path
          transform="rotate(2.57 228.742 175.735)"
          fill="#fcba28"
          d="M211.85 167.74H245V183.3H211.85z"
        />
      </g>
      <g
        id="pepper"
        className="icon pepper"
        stroke="#231f20"
        strokeLinejoin="round"
        strokeWidth={0.57}
      >
        ...
        <ellipse
          ...
          rx={1.89}
          ry={4.99}
          transform="rotate(-43.69 238.908 242.903)"
          fill="#0ba95b"
        />
        <path
      ...
      >
        ...
        <g>
          <path
            fill="#ed203d"
            d="M116.61 160.54L116.96 151.03 150.66 167.72 143.25 173.82 116.61 160.54z"
          />
          <rect
            x={113.49}
            y={155.76}
            ...
            rx={3.21}
            ry={3.21}
            transform="rotate(26.35 134.032 159.003)"
            fill="#fc7428"
          />
          <path
            ...
            fill="#fcba28"
          />
          <circle cx={129.34} cy={170.22} r={4.01} fill="#ed203d" />
          <path
      ...
      <g id="taco" className="icon taco">
        ...
        <rect
          ...
          rx={0.44}
          ry={0.44}
          transform="rotate(-14.07 218.707 166.023)"
          fill="#f9f4da"
          stroke="#231f20"
          strokeLinejoin="round"
          strokeWidth={0.64}
        ...
        <rect
          ...
          rx={0.51}
          ry={0.51}
          transform="rotate(-28.17 213.215 169.386)"
          fill="#f9f4da"
          stroke="#231f20"
          strokeLinejoin="round"
          strokeWidth={0.64}
